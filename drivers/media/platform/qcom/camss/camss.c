...
static const struct camss_subdev_resources csiphy_res_nord[] = {
	/* CSIPHY0 */
	{
		.regulators = {
			{ .supply = "vdd-csiphy0-0p8", .init_load_uA = 151020 },
...
/*
 * Nord's camcc has a dedicated CAM_CC_TOP_IFE_n clock per IFE (and a single
 * CAM_CC_TOP_IFE_LITE_CLK for the lites), instead of the shared cpas_vfe0/1/2
 * triple kaanapali votes. Keep the gen4 clock naming where the role matches
 * and introduce top_ifeN / top_ife_lite for the genuinely-new per-IFE TOP
 * clocks. Clock rates mirror the kaanapali gen4 tables and are HPG-pending.
 */
static const struct camss_subdev_resources vfe_res_nord[] = {
	/* VFE0 - TFE Full */
	{
		.clock = { "gcc_axi_hf", "vfe0_fast_ahb", "vfe0",
			   "top_ife0", "camnoc_rt_axi", "camnoc_nrt_axi",
			   "qdss_debug_xo" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 360280000, 480000000, 630000000, 716000000,
	...
	{
		.clock = { "gcc_axi_hf", "vfe1_fast_ahb", "vfe1",
			   "top_ife1", "camnoc_rt_axi", "camnoc_nrt_axi",
			   "qdss_debug_xo" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 360280000, 480000000, 630000000, 716000000,
	...
	{
		.clock = { "gcc_axi_hf", "vfe2_fast_ahb", "vfe2",
			   "top_ife2", "camnoc_rt_axi", "camnoc_nrt_axi",
			   "qdss_debug_xo" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 360280000, 480000000, 630000000, 716000000,
...
/*
 * ICC bandwidth votes mirror the kaanapali gen4 numbers as a placeholder and
 * are HPG-pending: source the real avg/peak from Nord's own capture-mode BW
 * before upstreaming. Based on 4096 x 3072 30 FPS 2496 Mbps mode.
 */
...
static const struct camss_resources nord_resources = {
	...
	.csiphy_num = ARRAY_SIZE(csiphy_res_nord),
