...
#define BUS_REG_BASE_900	(vfe_is_lite(vfe) ? 0x3700 : 0xA00)
...
#define BUS_WR_BLOCK_BASE_900	(vfe_is_lite(vfe) ? 0x3400 : 0x700)

#define VFE_BUS_WM_CGC_OVERRIDE			(BUS_REG_BASE + 0x08)
#define		WM_CGC_OVERRIDE_ALL			(0x7FFFFFF)

#define VFE_BUS_WM_TEST_BUS_CTRL \
	(IS_VFE_900(vfe) ? (BUS_WR_BLOCK_BASE_900 + 0x144) : (BUS_REG_BASE + 0x128))
